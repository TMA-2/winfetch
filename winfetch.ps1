...
function info_locale_old {
    ...
    $languageLookup = @{
        ...
        'mgo'       = 'Metaʼ';                       'mgo-CM'   = 'Metaʼ (Cameroon)';                'mi'       = 'Maori';
        ...
        'nqo'       = 'ngo';                         'nqo-GN'   = 'ngo (Guinea)';                    'nr'       = 'South Ndebele';
        ...
        'pt-ST'     = 'Portuguese (São Tomé and Príncipe)'; 'pt-TL' = 'Portuguese (Timor-Leste)';    'quc'      = 'Kʼicheʼ';
        'quc-Latn'  = 'Kʼicheʼ';                     'quc-Latn-GT' = 'Kʼicheʼ (Guatemala)';          'quz'      = 'Quechua';
...
if(!$nooutput) {
    ...
    # Load each function without output
    foreach ($item in $config) {
        if (Test-Path Function:"info_$item") {
            if ($timed) {
                $infotime = Measure-Command { & "info_$item" | Out-Null }
                $timetotal += $infotime
            } else {
                . "info_$item" | Out-Null
            }
        } else {
            Write-Warning "Function 'info_$item' not found!"
        }
    }
}
